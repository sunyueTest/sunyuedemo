...
$('#address').attr('placeholder', $.i18n.prop('emailPo'));
$('#nodeNameSpan').text($.i18n.prop('节点名称'));
$('#nodeName').attr('placeholder', $.i18n.prop('nodeNumberName'));
...
function onClick(e, treeId, treeNode) {
    ...
    if (treeNode.type == 'email') {
        address.value = parent.userData.user.email;
    } else if (treeNode.type == 'tel') {
        address.value = parent.userData.user.tel;
    }
}
            ...
            success: function (data) {
                ...
                if (data.state == 'success') {
                    ...
                    if (msg.indexOf("err106/") == 0) {
                        ...
                        feeEscalation($.i18n.prop("triggerNum"), num);
                    } else if (msg == 'err108') {
                        renewal();
                    } else {
