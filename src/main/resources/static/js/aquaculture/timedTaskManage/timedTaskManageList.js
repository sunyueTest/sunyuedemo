...
layui.use('table', function () {
    let tableData = [
        ...
        {field: 'createTime', title: $.i18n.prop('createTime'), width: 200, align: 'center'},
        {
            field: '',
    ...
    table.render({
        elem: '#table'
        , url: '../timeTaskManage/getTimeTaskManageList'
        , toolbar: '#toolbar1'
        , title: ''
        , cols: [tableData]
        , page: true,
