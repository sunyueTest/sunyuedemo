...
(function (global, factory) {
    ...
    // var mpegJS = Domain + '/sdk/js/2.0/jsmpeg.min.js';
    // var ckplayerJS = Domain + '/sdk/js/2.0/ckplayer/ckplayer.js';
    // var ckplayerSWF = Domain + '/sdk/js/2.0/ckplayer/ckplayer.swf';
    // var m3u8SWF = Domain + '/sdk/js/2.0/ckplayer/m3u8.swf';
    // var hlsJS = Domain + '/sdk/js/2.0/hls.min.js';
