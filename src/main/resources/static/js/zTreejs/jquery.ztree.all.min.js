...
(function(r) {
    var J, K, L, M, N, O, v, t = {},
        ...
        e = {
            ...
            initCache: function(a) {
                for (var b = 0,
                         c = A.length; b < c; b++) A[b].apply(this, arguments)
            },
            initNode: function(a, b, c, d, e, i) {
                for (var m = 0,
                         g = B.length; m < g; m++) B[m].apply(this, arguments)
            },
            initRoot: function(a) {
                for (var b = 0,
                         c = C.length; b < c; b++) C[b].apply(this, arguments)
            },
            ...
            removeNodeCache: function(a, b) {
                ...
                if (c) for (var d = 0,
                                f = c.length; d < f; d++) e.removeNodeCache(a, c[d]);
            ...
            transformToArrayFormat: function(a, b) {
                ...
                if (!b) return [];
                var d = [];
                if (h.isArray(b)) for (var f = 0,
                                           i = b.length; f < i; f++) c(b[f]);
                else c(b);
                return d
            },
    ...
    var h = {
            ...
            getMDom: function(a, b, c) {
                ...
                for (; b && b.id !== a.treeId;) {
                    for (var d = 0,
                             e = c.length; b.tagName && d < e; d++) if (h.eqs(b.tagName, c[d].tagName) && b.getAttribute(c[d].attrName) !== null) return b;
                    b = b.parentNode
                }
                return null
            },
        ...
        j = {
            ...
            appendParentULDom: function(a, b) {
                var c = [],
                    d = l(b, a); ! d.get(0) && b.parentTId && (j.appendParentULDom(a, b.getParentNode()), d = l(b, a));
                var f = l(b, g.id.UL, a);
                f.get(0) && f.remove();
            ...
            expandCollapseSonNode: function(a, b, c, d, f) {
                ...
                if (i) for (var h = 0,
                                l = i.length; h < l; h++) i[h] && j.expandCollapseSonNode(a, i[h], c, g);
            ...
            makeNodeIcoStyle: function(a, b) {
                ...
                if (!b.isAjaxing) {
                    ...
                    d && c.push("background:url(", d, ") 0 0 no-repeat;"); (a.view.showIcon == !1 || !h.apply(a.view.showIcon, [a.treeId, b], !0)) && c.push("width:0px;height:0px;")
                }
                return c.join("")
            },
        ...
        init: function(a, b, c) {
            ...
            var f = {
                ...
                expandNode: function(a, b, c, f, g) {
                    ...
                    e.getRoot(d).expandTriggerFlag = g; ! h.canAsync(d, a) && c ? j.expandCollapseSonNode(d, a, b, !0, n) : (a.open = !b, j.switchNode(this.setting, a), n());
                    return b
                },
                getNodes: function() {
                    return e.getNodes(d)
            ...
            a.treeTools = f;
            e.setZTreeTools(d, f); (c = e.nodeChildren(d, a)) && c.length > 0 ? j.createNodes(d, 0, c, null, -1) : d.async.enable && d.async.url && d.async.url !== "" && j.asyncNode(d);
            return f
        }
    };
    var Q = r.fn.zTree,
