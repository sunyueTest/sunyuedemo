/* esri-leaflet - v2.3.1 - Thu Oct 10 2019 14:36:18 GMT-0500 (Central Daylight Time)
...
! function (t, e) {
        ...
        ut = e.TileLayer.extend({
            statics: {
                TILES: {
                    ...
                    chinagray: {
                        urlTemplate: "http://cache1.arcgisonline.cn/ ... tile/{z}/{y}/{x}",
                        options: {
                            minZoom: 1,
                            maxZoom: 19,
                        }
    ...
    t.VERSION = "2.3.1", t.Support = r, t.options = n, t.Util = Z, t.get = m, t.post = l, t.request = p, t.Task = j, t.task = function (t) {
